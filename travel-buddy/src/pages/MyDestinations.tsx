...
const MyDestinations: NextPage = () => {
    ...
    async function getDestinationsHelper() {
        const firebasecontroller = new firebaseControl();
        if (auth.currentUser) {
            firebasecontroller.getUserVisitedDestinationsWithReview(auth.currentUser.uid).then((destinationsFirebase) => {
